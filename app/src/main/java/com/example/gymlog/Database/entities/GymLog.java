...
public class GymLog {
    ...
    public boolean equals(Object o) {
        ...
        return id == gymLog.id && Double.compare(weight, gymLog.weight) == 0 && Objects.equals(exercise, gymLog.exercise) && Objects.equals(date, gymLog.date);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, exercise, weight, date);
    }
